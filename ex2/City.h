...
namespace mtm
{
    ...
    // vector<VectorType>::iterator findInVector(vector<VectorType> my_vector, const int id)
    // {
    //     vector<VectorType>::iterator it = my_vector.begin();
    //     it = std::find_if(my_vector.begin(), my_vector.end(), isEqualById(id));
    //     return it;
    // } 
